...
public class ProtocolNode {
	public String tag;
	public LinkedHashMap<String, String> attributeHash;
	public List<ProtocolNode> children;
	public String data;

	public ProtocolNode(String tag, LinkedHashMap<String, String> attributeHash,
			List<ProtocolNode> children, String data) {
		this.tag = tag;
		this.attributeHash = attributeHash;
		if (attributeHash == null)
			this.attributeHash = new LinkedHashMap<String, String>();
