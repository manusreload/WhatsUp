...
public class Constants {
    ...
    public static final String WHATSAPP_HOST = "c.whatsapp.net";
    public static final String WHATSAPP_SERVER = "s.whatsapp.net";
    public static final String WHATSAPP_REALM = "s.whatsapp.net";
    public static final String WHATSAPP_REQ_HOST = "v.whatsapp.net/v2/code";
    public static final String WHATSAPP_REG_HOST = "v.whatsapp.net/v2/register";
